          ...
          children: <Widget>[
            ...
            new Card(
              child: new Container(
                ...
                child: new charts.LineChart(<charts.Series<dynamic, num>>[
                  new charts.Series<double, int>(
                    id: 'Playtime',
                    domainFn: (double playTimes, int index) => index,
                    measureFn: (double playTime, int index) => playTime,
                    colorFn: (double playTime, int index) =>
                        new charts.Color.fromHex(code: '#1775D1'),
                ...
                child: new charts.LineChart(
                  <charts.Series<dynamic, num>>[
                    new charts.Series<int, int>(
                      ...
                      colorFn: (int games, int index) =>
                      new charts.Color.fromHex(code: '#FF590A'),
                    ...
                    new charts.Series<int, int>(
                      ...
                      measureFn: (int games, int index) => games,
                      colorFn: (int games, int index) =>
                          new charts.Color.fromHex(code: '#08D48C'),
